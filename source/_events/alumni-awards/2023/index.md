    ...
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>Susan (Su) Nerton</strong> (Crown ’71, psychology; computer and information science ’87)</h2>
          ...
          <div class="media">
            <div class="image">
              <img class="profile-image" src="images/susan-norten.jpg" alt="Susan (Su) Nerton (Crown ’71, psychology; computer and information science ’87)">
            </div>    
          </div>
        </div>
      </div>
  ...
  <section class="profile-w-media left">
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>Lisa Rose</strong> (Crown ’72, Russian literature)</h2>
  ...
  <section class="profile-w-media left">
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>Jim Lapsley</strong> (Crown ’71, history)</h2>
          ...
          <div class="media">
            <div class="image">
              <img class="profile-image" src="images/jim-lapsley.jpg" alt="Jim Lapsley (Crown ’71, history)">
            </div>    
          </div>
        </div>
      </div>
  ...
  <section class="profile-w-media left">
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>bell hooks</strong> (Ph.D. ’83, literature)</h2>
  ...
  <section class="profile-w-media left">
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>Mark Phillips</strong> (Ph.D. ’77, astronomy)</h2>
          ...
          <div class="media">
            <div class="image">
              <img class="profile-image" src="images/mark-phillips.jpg" alt="Mark Phillips (Ph.D. ’77, astronomy)">
            </div>    
          </div>
        </div>
      </div>
  ...
  <section class="profile-w-media left">
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>Abel Pineda</strong> (Oakes ’14, sociology)</h2>
          ...
          <div class="media">
            <div class="image">
              <img class="profile-image" src="images/abel-pineda.jpg" alt="Abel Pineda (Oakes ’14, sociology)">
            </div>    
          </div>
        </div>
      </div>
  ...
  <section class="profile-w-media left">
    <div class="grid-container large">
      <div class="profile">
        <div class="inner wave-pattern pink">
          <div class="content">
              <h2 class="underline"><strong>Bettina Aptheker</strong> (Ph.D. ’83, history of consciousness)</h2>
          ...
          <div class="media">
            <div class="image">
              <img class="profile-image" src="images/bettina-aptheker.jpg" alt="Bettina Aptheker (Ph.D. ’83, history of consciousness)">
            </div>    
          </div>
        </div>
      </div>
