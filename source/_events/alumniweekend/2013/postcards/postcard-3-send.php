...
#card .message {
    ...
    opacity: 0.75; /* Firefox/Opera/Safari/Chrome. Basically all the freaking sweet browsers. */ 
...
.input {
    ...
    background-color: #FFF;
    opacity: 0.85; /* Firefox/Opera/Safari/Chrome. Basically all the freaking sweet browsers. */ 
...
.sharethis .edit a img { position:absolute; right:0px; }
.sharethis .edit a:focus img,
.sharethis .edit a:hover img { right:-32px; }
.sharethis .text {
    display: inline-block;
    vertical-align: top;
    padding-top: 7px;
...
<body class="contentSingleCol homeEnv">
 <div id="wrap">
   <div id="container">
     <div id="content">
...
<li><a href="http://www.ucsc.edu/quickstart/community/index.html">Community</a></li>
       ...
       <div id="sprflt">
         ...
         <div id="mainContent">
          ...
          <h1 id="title">Postcard</h1><div class="contentBox">
          <?php
    if(strstr($_SERVER['HTTP_REFERER'], "/alumniweekend/2013/postcards/postcard_three.html")) {
        echo '<div class="sharethis">';
        echo '<p>
              <span class="text">EDIT:</span> <span class="edit"><a href="javascript:history.go(-1)"><img alt="Edit your card" src="images/edit-button.png" title="Edit your card" alt="Edit your card"/></a></span>
              <span class="text">SHARE YOUR CARD:</span> 
              <span class="st_facebook_large" displayText="Facebook"></span>
              <span class="st_twitter_large" displayText="Tweet"></span>
              <span class="st_googleplus_large" displayText="Google +"></span>
              <!-- <span class="st_email_large" displayText="Email"></span> -->
              <span class="edit"><a href="#inline1" class="fancybox"><img alt="Edit your card" src="images/email_32.png" title="Edit your card" alt="Edit your card"/></a></span>
              </p></div>';
    }
    else {
        echo '<div class="sharethis" style="text-align:center;">';
        echo '<span class="text">CREATE & SHARE:</span> <a href="index.html"><img alt="Edit your card" src="images/postcard-thumb.png" title="Create and share" alt="Create and share" border="0"/></a></div>';
    }
?>
          
<div style ="position:relative;overflow:hidden;margin:auto;width:652px;height:737px;">

<div id="card">
    <div class="left">
    
        <p align="center">From:<div class="message"><?php echo $_GET["name"]; ?></div></p>
        
        <p align="center">To:
        <div class="message"><?php echo $_GET["recipient"]; ?></div></p>
        
        <p align="center">Message:
        <div class="message"><?php echo $_GET["message"]; ?></div></p>
    ...
    <div style="position: relative; overflow: hidden; width: 652px; height: 737px;" id="postcard3_hype_container">
<script type="text/javascript" src="postcard-3.resources/postcard3_hype_generated_script.js?4015" charset="utf-8"></script>
</div>
...
<h2>Send this postcard to a friend</h2>
<p>Recipient's Email:<font color="red">*</font><br />
<input  type="text" name="email" maxlength="100%" size="30">
</p>
<p>Your Email:<font color="red">*</font><br />
<input  type="text" name="sender" maxlength="100%" size="30">
</p>
<p><input type="hidden" name="card" value="<?php $long_url = selfURL(); echo bit_ly_short_url($long_url); ?>" maxlength="100%" size="30"></p>
<p>Comments:<br />
...
<script type="text/javascript">
  ...
  (function() {
    ...
    t.async = true;
    t.id    = 'gauges-tracker';
    t.setAttribute('data-site-id', '501c4647f5a1f52a1000000f');
    t.src = '//secure.gaug.es/track.js';
    var s = document.getElementsByTagName('script')[0];
    s.parentNode.insertBefore(t, s);
  })();
</script>
<!-- End of gaug.es stats -->
<?php
function selfURL() {
