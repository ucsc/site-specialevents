...
.input {
    ...
    background-color: #FFF;
    opacity: 0.9; /* Firefox/Opera/Safari/Chrome. Basically all the freaking sweet browsers. */ 
...
<div style ="position:relative;overflow:hidden;margin:auto;width:802px;height:487px;">

<div id="card">
    <div class="left">
    
        <p>From:<div class="message"><?php echo $_GET["name"]; ?></div></p>
    ...
    <div id="postcard_hype_container" style="position:relative;overflow:hidden;width:802px;height:487px;">
        <script type="text/javascript" src="postcard_resources/postcard_hype_generated_script.js?54356"></script>
    </div>
...
<?php
    if(strstr($_SERVER['HTTP_REFERER'], "/alumniweekend/2013/postcards/postcard_one.html")) {
